# 0 "/home/osklot12/code/reasonate_cli/shader/Shader.cpp"
# 1 "/home/osklot12/code/reasonate_cli/cmake-build-debug//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/osklot12/code/reasonate_cli/shader/Shader.cpp"
...
# 8 "/home/osklot12/code/reasonate_cli/shader/Shader.h" 2
...
# 9 "/home/osklot12/code/reasonate_cli/shader/Shader.h" 2
...
# 6 "/home/osklot12/code/reasonate_cli/shader/Shader.cpp" 2
...
# 7 "/home/osklot12/code/reasonate_cli/shader/Shader.cpp" 2


# 8 "/home/osklot12/code/reasonate_cli/shader/Shader.cpp"
constexpr size_t LOG_SIZE = 512;

Shader::Shader(const std::string &source_code, SHADER_TYPE type) : type(type) {
    id = glad_glCreateShader(type == SHADER_TYPE::VERTEX ? 0x8B31 : 0x8B30);
    if (id == 0) {
...
void Shader::compile(const std::string &source_code) {
    ...
    glad_glShaderSource(id, 1, &code, 
# 44 "/home/osklot12/code/reasonate_cli/shader/Shader.cpp" 3 4
                                __null
# 44 "/home/osklot12/code/reasonate_cli/shader/Shader.cpp"
                                    );
    glad_glCompileShader(id);

    GLint success;
    glad_glGetShaderiv(id, 0x8B81, &success);
    if (!success) {
        char info_log[LOG_SIZE];
        glad_glGetShaderInfoLog(id, LOG_SIZE, nullptr, info_log);
